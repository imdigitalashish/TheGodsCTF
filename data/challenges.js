/* ============================================================
   THE GODS CTF — challenges.js  (FULL SET, 14 cases)
   Auto-generated from the 14 Asur transcripts via the content
   workflow (author -> adversarial validation). Every transcript
   quote was verified against the source file. Schema matches
   the AsurOS case engine.
   ============================================================ */
