/* ============================================================
   THE GODS CTF — world.ts
   Static world data: Spell Notion server fleet, agent ranks,
   periodic-table subset for the cipher decoder.
   ============================================================ */
import type { ServerNode, Rank, ElementInfo } from "@/types";
...
/** 25 nodes across India. The hidden SN-05 (Noida) carries ~10x the
    outgoing traffic of every other node — the S2E07 anomaly. */
export const servers: ServerNode[] = [
  { id: "SN-01", city: "Mumbai", lat: 19.076, lng: 72.8777, size: "big", txGbps: 94 },
  { id: "SN-02", city: "Delhi", lat: 28.6139, lng: 77.209, size: "big", txGbps: 88 },
  ...
  { id: "SN-05", city: "Noida, Phase-2, Dadri Road", lat: 28.57, lng: 77.34, size: "hidden", txGbps: 947, hidden: true },
  { id: "SN-06", city: "Hyderabad", lat: 17.385, lng: 78.4867, size: "mid", txGbps: 31 },
